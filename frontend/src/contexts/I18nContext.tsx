...
const translations: Record<Lang, Record<string, string>> = {
  de: {
    ...
    'r6.description.text1': 'Team Apx tritt im taktischen Shooter Rainbow Six Siege an. Wir stehen für präzises Teamplay, strategisches Denken und den Willen, auf höchstem Niveau zu konkurrieren.',
    'r6.description.stat.game': 'Spiel',
    'r6.description.stat.founded': 'Gegründet',
    'r6.description.stat.players': 'Spieler',
    ...
    'profile.placeholder.bio': 'Kurze Beschreibung…',
    ...
    // Event detail
    'event.detail.back': 'Zurück',
    'event.detail.join': 'Event beitreten',
    'event.detail.leave': 'Event verlassen',
    'event.detail.full': 'Ausgebucht',
    'event.detail.noAccess': 'Kein Zugang',
    'event.detail.noAccessTooltip': 'Du hast keinen Zugang zu Events.',
    'event.detail.loginRequired': 'Bitte einloggen',
    'event.detail.participants': 'Teilnehmer',
    'event.detail.noParticipants': 'Noch keine Teilnehmer.',
    'event.detail.notFound': 'Event nicht gefunden.',
    'event.detail.joinError': 'Beitreten fehlgeschlagen.',
    'event.detail.leaveError': 'Verlassen fehlgeschlagen.',

    // Admin – Team event access
    'admin.team.eventAccess': 'Event Access',
    'admin.team.eventAccessHint': 'Nur verfügbar, wenn ein Username verknüpft ist.',

    // Admin – Events page
    'admin.events.title': 'Events verwalten',
    'admin.events.empty': 'Noch keine Events.',
    'admin.events.participants': 'Teilnehmer',
    'admin.events.addEvent': 'Event hinzufügen',
    'admin.events.editEvent': 'Event bearbeiten',
    'admin.events.confirmDelete': 'Event wirklich löschen?',
    'admin.events.field.name': 'Name',
    'admin.events.field.date': 'Datum',
    'admin.events.field.status': 'Status',
    'admin.events.field.durationDe': 'Zeitraum (DE)',
    'admin.events.field.durationEn': 'Zeitraum (EN)',
    'admin.events.field.descriptionDe': 'Beschreibung (DE)',
    'admin.events.field.descriptionEn': 'Beschreibung (EN)',
    'admin.events.field.maxParticipants': 'Max. Teilnehmer (0 = unbegrenzt)',
  },
  en: {
    'nav.home': 'Home',
    'nav.potw': 'Weekly Performance',
    ...
    'r6.description.text1': 'Team Apx competes in the tactical shooter Rainbow Six Siege. We stand for precise teamplay, strategic thinking, and the drive to compete at the highest level.',
    'r6.description.stat.game': 'Game',
    'r6.description.stat.founded': 'Founded',
    'r6.description.stat.players': 'Players',
    ...
    'profile.placeholder.bio': 'Short description…',
    ...
    'event.detail.join': 'Join Event',
    'event.detail.leave': 'Leave Event',
    'event.detail.full': 'Full',
    'event.detail.noAccess': 'No access',
    'event.detail.noAccessTooltip': 'You do not have access to events.',
    'event.detail.loginRequired': 'Please log in',
    'event.detail.participants': 'Participants',
    'event.detail.noParticipants': 'No participants yet.',
    'event.detail.notFound': 'Event not found.',
    'event.detail.joinError': 'Failed to join.',
    'event.detail.leaveError': 'Failed to leave.',

    // Admin – Team event access
    'admin.team.eventAccess': 'Event Access',
    'admin.team.eventAccessHint': 'Only available when a username is linked.',

    // Admin – Events page
    'admin.events.title': 'Manage Events',
    'admin.events.empty': 'No events yet.',
    'admin.events.participants': 'participants',
    'admin.events.addEvent': 'Add Event',
    'admin.events.editEvent': 'Edit Event',
    'admin.events.confirmDelete': 'Really delete this event?',
    'admin.events.field.name': 'Name',
    'admin.events.field.date': 'Date',
    'admin.events.field.status': 'Status',
    'admin.events.field.durationDe': 'Duration (DE)',
    'admin.events.field.durationEn': 'Duration (EN)',
    'admin.events.field.descriptionDe': 'Description (DE)',
    'admin.events.field.descriptionEn': 'Description (EN)',
    'admin.events.field.maxParticipants': 'Max. participants (0 = unlimited)',
  },
}
